...
struct Node {
	...
	// // Default constructor
	// Node(): next(nullptr) {} // remember to initialize next to nullptr
	// Node(std::string id, int year, int month, double temperature): next(nullptr) {} // remember to initialize next to nullptr
	// Default constructor
